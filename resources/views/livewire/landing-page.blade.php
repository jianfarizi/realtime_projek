<div>
      <section class="cover-background overflow-visible"
        style="background-image: url('/landing/images/landing/bird-sunset.png');">
        <div class="container overlap-section">
            <div class="row row-cols-1 row-cols-xl-5 row-cols-md-5 row-cols-sm-3 bg-white border-radius-6px mx-0 ps-8 pe-8 lg-ps-3 lg-pe-3 pt-4 pb-4 sm-pt-8 sm-pb-8 xs-pt-15 xs-pb-40px align-items-center mb-7 xs-mb-50px justify-content-center"
                ...
                <div class="col text-center border-end border-color-extra-medium-gray sm-mb-40px xs-border-end-0">
                    <svg class="mb-10px w-70px d-block mx-auto" width="125" height="125" viewBox="0 0 24 24"
                        fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v1h16v-1c0-2.66-5.33-4-8-4z" fill="#BC8947"/>
                    </svg>

                    <span class="alt-font fs-19 fw-600 text-dark-gray text-uppercase ls-minus-05px"><a>{{ $pendaki }}</a> Orang Sudah Mendaki</span>
                </div>

                <div class="col text-center border-end border-color-extra-medium-gray sm-mb-40px xs-border-end-0">
                    <svg class="mb-10px w-70px d-block mx-auto" width="125" height="125" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17h-2v-6h2v6zm0-8h-2V7h2v4z" fill="#BC8947"/>
                    </svg>

                    <span class="alt-font fs-19 fw-600 text-dark-gray text-uppercase ls-minus-05px">Route</span>
                </div>

               <div class="col text-center border-end border-color-extra-medium-gray sm-mb-40px xs-border-end-0">
                <svg class="mb-10px w-70px d-block mx-auto" width="125" height="125" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M3 6h18M6 6v14c0 .55.45 1 1 1h10c.55 0 1-.45 1-1V6M9 3v1h6V3H9zm12 3H3v14c0 2.21 1.79 4 4 4h10c2.21 0 4-1.79 4-4V6z" fill="#BC8947"/>
                </svg>

                <span class="alt-font fs-19 fw-600 text-dark-gray text-uppercase ls-minus-05px">Trash</span>
            </div>

                <div class="col text-center border-end border-color-extra-medium-gray xs-border-end-0 xs-mb-40px">
                    <svg class="mb-10px w-70px d-block mx-auto" width="125" height="125" viewBox="0 0 24 24"
                        fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M8 22H16" stroke="#BC8947" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path opacity="0.5" d="M5 19H19" stroke="#BC8947" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M2 16H22" stroke="#BC8947" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path opacity="0.5"
                            ...
                            stroke="#BC8947" stroke-width="1.5" />
                        <path opacity="0.5" d="M12 2V3" stroke="#BC8947" stroke-width="1.5"
                            stroke-linecap="round" />
                        <path opacity="0.5" d="M22 12L21 12" stroke="#BC8947" stroke-width="1.5"
                            stroke-linecap="round" />
                        <path opacity="0.5" d="M3 12L2 12" stroke="#BC8947" stroke-width="1.5"
                            stroke-linecap="round" />
                        <path opacity="0.5" d="M19.0708 4.92969L18.678 5.32252" stroke="#BC8947" stroke-width="1.5"
                            stroke-linecap="round" />
                        <path opacity="0.5" d="M5.32178 5.32227L4.92894 4.92943" stroke="#BC8947" stroke-width="1.5"
                            stroke-linecap="round" />
                    </svg>
